local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/Jerry-r-c/RaptureHub/refs/heads/main/Ui.txt"))()

local main = Library.new()
if main and main.RootGui then
    main.RootGui.Parent = LocalPlayer:WaitForChild("PlayerGui")
end
...
local function create_curve_selector_mobile()
    ...
    toggle_btn.MouseButton1Click:Connect(function()
        ...
        toggle_btn.Text = is_expanded and "̢蠉۪" or "+"
...
StarterGui:SetCore('SendNotification', {
    Title = 'BETA',
    Text = 'This Version is on BETA for real',
